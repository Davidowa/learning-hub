...
Diapositivas, código y recursos para cursos de Ciencias de la Computación en **Universidad Panamericana**.

## Cursos

<img src="courses/computational-thinking-course/assets/computational-thinking-banner.jpg" alt="Banner de Pensamiento Computacional" width="100%">
...
- **Idioma:** cambia entre English / Español en el encabezado.
- **Búsqueda:** presiona `/` en cualquier página.
- **Código fuente:** [Repositorio GitHub](https://github.com/davidowa/learning-hub).

## Ruta sugerida

1. [Pensamiento Computacional](courses/computational-thinking-course/index.md)
2. [CS (C#)](courses/cs-course/index.md)
3. [Python](courses/python-course/index.md)
