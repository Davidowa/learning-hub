...
<img src="https://raw.githubusercontent.com/FortAwesome/Font-Awesome/6.x/svgs/solid/hard-hat.svg" width="20" height="20" alt=""> **En construcción.** Esquema abajo; contenido en camino.
...
- **06 · Control de flujo** — `if` / `else`, `switch`, `while`, `do-while`, `for`, `foreach`.
...
[`courses/cs-course/`](https://github.com/davidowa/learning-hub/tree/main/courses/cs-course)
